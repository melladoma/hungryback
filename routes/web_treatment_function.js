module.exports = function (str) {
    ...
    var isEndElement = (element) => element.includes("Signaler une erreur dans le texte de la recette")
    ...
    //servings
    resultObj.servings = parseInt((workArr.find(value => /^[0-9] parts/.test(value))).match(/[0-9]/)[0]);
